  ...
  begin
    ...
    begin
      ...
      HexToBitmap(
        ...
        '770077770C770C77770077777C777C7777007777777777777700', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
    ...
    begin
      ...
      HexToBitmap(
        ...
        '770077770C777777770077777C77777777007777777777777700', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
    ...
    begin
      ...
      HexToBitmap(
        ...
        '770077777777C077770077777777C77777007777777777777700', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
      OnMouseDown := SpeedButtonPriorMouseDown;
    ...
    begin
      ...
      HexToBitmap(
        ...
        '77007777C077C07777007777C777C77777007777777777777700', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
    ...
    begin
      ...
      HexToBitmap(
        ...
        '777777000000777777777777777777000000', Glyph);
      Spacing := -1;
...
{    SpeedButtonSetup:=TSpeedButton.Create(Self);
    ...
    begin
      ...
      HexToBitmap(
        ...
        'BBBBBBBBBB0000BBBBBBBBBBBBB00BBBBBBB', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
    ...
    begin
      ...
      HexToBitmap(
        ...
        'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB', Glyph);
      ParentShowHint := False;
      ShowHint := True;
      Spacing := -1;
